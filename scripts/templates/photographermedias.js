export default class PhotographerMedias {
  ...
  createPhotographerMedias() {
    ...
    if (!profilePageContent) {
      console.error("Element .main_content_medias not found");
      return;
    }
    ...
    const content = `
      ...
      <aside>
        ...
        <span>${this.photographer && this.photographer.price ? this.photographer.price : 'Prix non disponible'}€ / jour</span>
      </aside>
    `;
